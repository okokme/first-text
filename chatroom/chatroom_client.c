...
/*
    gcc chatroom_client.c -o chatroom_client -pthread
    ./chatroom_client -a 128.0.0.233 -p 8888
...
void my_zone_access(int k)
{
    ...
    struct message chat;
    chat = chat_t[k];
    printf("“手动点赞”输入‘1’,“我不同意！”输入‘2’，“评论”输入‘3’,退出输入“0”:");
    setbuf(stdin,NULL);
    scanf("%c",&choice);
    switch(choice)
    {
...
int my_zone()
{
    ...
    for(k = 20,t = 1;k < d;k++,t++)
    {
       // printf("[序号]  %d  \n“%s”发表状态:%s\n",t,chat_t[k].from,chat_t[k].news);
        printf("[序号]  %d\n \e[1;32m”%s“ 发表状态：%s\033[0m \n",t,chat_t[k].from,chat_t[k].news);

    }
    printf("\n\n\n\n\n");
    printf("请输入要“手动点赞”或“不同意”或“评论”的序号(序号为‘0’退出空间)：");
    scanf("%d",&choice);
    if(choice == 0)
    {
        return 0;
...
int message_ment()      //通知类消息管理
{
    ...
    do
    {
        ...
        printf("\t\t\033[;34m\33[1m*\033[0m                               \033[;34m\33[1m*\033[0m\n");
        printf("\t\t\033[;34m\33[1m*\033[0m                               \033[;34m\33[1m*\033[0m\n");         
        printf("\t\t\033[;34m\33[1m*\033[0m        1.添加好友请求[%d]       \033[;34m\33[1m*\033[0m\n",b);
        printf("\t\t\033[;34m\33[1m*\033[0m        2.申请入群请求[%d]       \033[;34m\33[1m*\033[0m\n",c-10);
        printf("\t\t\033[;34m\33[1m*\033[0m        3.文件发送请求[%d]       \033[;34m\33[1m*\033[0m\n",d-20);
        printf("\t\t\033[;34m\33[1m*\033[0m        0.返回上级菜单         \033[;34m\33[1m*\033[0m\n");
        printf("\t\t\033[;34m\33[1m*\033[0m                               \033[;34m\33[1m*\033[0m\n");
        printf("\t\t\033[;34m\33[1m*\033[0m                               \033[;34m\33[1m*\033[0m\n"); 
...
int public_chat()                        //群聊
{
    ...
    while(1)
    {
        printf("%s",my_time());
       //printf("%s说：",near.from);
        printf("\e[1;32m%s说：\033[0m",near.from);
...
int chat_with()
{
    ...
    do
    {
        ...
        printf("\t\t\033[;34m\33[1m*\033[0m                               \033[;34m\33[1m*\033[0m\n");
        printf("\t\t\033[;34m\33[1m*\033[0m                               \033[;34m\33[1m*\033[0m\n");         
        printf("\t\t\033[;34m\33[1m*\033[0m        1.我要私聊             \033[;34m\33[1m*\033[0m\n");
        printf("\t\t\033[;34m\33[1m*\033[0m        2.查看我的群           \033[;34m\33[1m*\033[0m\n");
        printf("\t\t\033[;34m\33[1m*\033[0m        3.我要建群             \033[;34m\33[1m*\033[0m\n");
        printf("\t\t\033[;34m\33[1m*\033[0m        4.申请入群             \033[;34m\33[1m*\033[0m\n");
        printf("\t\t\033[;34m\33[1m*\033[0m        5.消息管理             \033[;34m\33[1m*\033[0m\n");
        printf("\t\t\033[;34m\33[1m*\033[0m        0.返回上级菜单         \033[;34m\33[1m*\033[0m\n");
        printf("\t\t\033[;34m\33[1m*\033[0m                               \033[;34m\33[1m*\033[0m\n");
        printf("\t\t\033[;34m\33[1m*\033[0m                               \033[;34m\33[1m*\033[0m\n"); 
        printf("\t\t\033[;34m\33[1m*********************************\033[0m\n");       
...
int admin_friend()                  //好友管理函数
{
    ...
    do
    {
        ...
        printf("\t\t\033[;34m\33[1m*\033[0m                               \033[;34m\33[1m*\033[0m\n");
        printf("\t\t\033[;34m\33[1m*\033[0m                               \033[;34m\33[1m*\033[0m\n");         
        printf("\t\t\033[;34m\33[1m*\033[0m        1.查看所有好友         \033[;34m\33[1m*\033[0m\n");
        printf("\t\t\033[;34m\33[1m*\033[0m        2.查看在线好友         \033[;34m\33[1m*\033[0m\n");
        printf("\t\t\033[;34m\33[1m*\033[0m        3.添加好友             \033[;34m\33[1m*\033[0m\n");
        printf("\t\t\033[;34m\33[1m*\033[0m        4.删除好友             \033[;34m\33[1m*\033[0m\n");
        printf("\t\t\033[;34m\33[1m*\033[0m        5.消息管理             \033[;34m\33[1m*\033[0m\n");
        printf("\t\t\033[;34m\33[1m*\033[0m        0.返回上级菜单         \033[;34m\33[1m*\033[0m\n");
        printf("\t\t\033[;34m\33[1m*\033[0m                               \033[;34m\33[1m*\033[0m\n");
        printf("\t\t\033[;34m\33[1m*\033[0m                               \033[;34m\33[1m*\033[0m\n"); 
...
void login_menu()            //登录主菜单
{
   ...
   // system("clear");
        ...
        printf("\t\t\033[;34m\33[1m*\033[0m                               \033[;34m\33[1m*\033[0m\n");
        printf("\t\t\033[;34m\33[1m*\033[0m                               \033[;34m\33[1m*\033[0m\n");         
        printf("\t\t\033[;34m\33[1m*\033[0m        1.查看附近的人         \033[;34m\33[1m*\033[0m\n");
        printf("\t\t\033[;34m\33[1m*\033[0m        2.好友管理             \033[;34m\33[1m*\033[0m\n");
        printf("\t\t\033[;34m\33[1m*\033[0m        3.聊天                 \033[;34m\33[1m*\033[0m\n");
        printf("\t\t\033[;34m\33[1m*\033[0m        4.查看聊天记录         \033[;34m\33[1m*\033[0m\n");
        printf("\t\t\033[;34m\33[1m*\033[0m        5.消息管理             \033[;34m\33[1m*\033[0m\n");
        printf("\t\t\033[;34m\33[1m*\033[0m        6.发个状态             \033[;34m\33[1m*\033[0m\n");
        printf("\t\t\033[;34m\33[1m*\033[0m        7.我的空间             \033[;34m\33[1m*\033[0m\n");
        printf("\t\t\033[;34m\33[1m*\033[0m        8.发送文件             \033[;34m\33[1m*\033[0m\n");
        printf("\t\t\033[;34m\33[1m*\033[0m        0.我要下线             \033[;34m\33[1m*\033[0m\n");
        printf("\t\t\033[;34m\33[1m*\033[0m                               \033[;34m\33[1m*\033[0m\n");
        printf("\t\t\033[;34m\33[1m*\033[0m                               \033[;34m\33[1m*\033[0m\n"); 
        printf("\t\t\033[;34m\33[1m*********************************\033[0m\n");
...
void *sign_func()
{
    while(1)
    {
        ...
        switch(chat.type)
        {
            ...
            {
                printf("\n");
                printf("你能成为世上最成熟，最甜美的那颗桃子，但记住，这世界上,总有人讨厌桃子。\n别和自己聊天了，去附近的人看看吧～\n");
                break;
            }
            case '7'://好友有新动态
            {  
...
/*
    gcc chatroom_client.c -o chatroom_client -pthread
    ./chatroom_client -a 128.0.0.236 -p 8888
