...
void byebye()
{
printf("\033[2J\033[5;32H");
printf("\t\033[36m  \n");

printf("           BBBBBBBBBBBBB      YY        YY       EEEEEEEEEEEE          \n");
printf("           BBB        BB       YY      YY        EEEEEEEEEEEE          \n");
printf("           BBB        BB        YY    YY         EE                    \n");
printf("           BBBBBBBBBBBBB         YY  YY          EEEEEEEEEEEE          \n");
printf("           BBBBBBBBBBBBB           YY            EEEEEEEEEEEE          \n");
printf("           BBB        BB           YY            EE                    \n");
printf("           BBB        BB           YY            EEEEEEEEEEEE          \n");
printf("           BBBBBBBBBBBBB           YY            EEEEEEEEEEEE          \n\n\n\n\n\n");
printf("\t\t\t\t\033[40m ~~~ 谢谢使用 ~~\n\033[0m");
}
